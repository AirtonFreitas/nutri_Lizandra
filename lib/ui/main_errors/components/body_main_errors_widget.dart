            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _bodyTwo(),
                  const Text('Ficar muito tempo sem se alimentar pode reduzir o metabolismo corporal.\n'
                  ...
                  _bodyFour(),
                  const Text('O exercício físico, principalmente aeróbico, aumenta a capacidade cardiorrespiratória e acelera o metabolismo, elevando o gasto energético – o que é popularmente conhecido como “queimar calorias” –, estimulando o emagrecimento.'
                    ,style: TextStyle(fontFamily: 'GeosansLight'),
                  ),],
              ),
            )));
