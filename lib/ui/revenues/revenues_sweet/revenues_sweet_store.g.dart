...
part of 'revenues_sweet_store.dart';
...
mixin _$RevenuesSweetStore on _RevenuesSweetStore, Store {
  late final _$bodyRevenueSelectedAtom =
      Atom(name: '_RevenuesSweetStore.bodyRevenueSelected', context: context);
  ...
  late final _$setRevenueAsyncAction =
      AsyncAction('_RevenuesSweetStore.setRevenue', context: context);
