...
part of 'revenues_food_store.dart';
...
mixin _$RevenuesFoodStore on _RevenuesFoodStore, Store {
  late final _$bodyRevenueSelectedAtom =
      Atom(name: '_RevenuesFoodStore.bodyRevenueSelected', context: context);
  ...
  late final _$setRevenueAsyncAction =
      AsyncAction('_RevenuesFoodStore.setRevenue', context: context);
