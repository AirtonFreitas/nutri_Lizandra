...
part of 'revenues_coffee_store.dart';
...
mixin _$RevenuesCoffeStore on _RevenuesCoffeStore, Store {
  late final _$bodyRevenueSelectedAtom =
      Atom(name: '_RevenuesCoffeStore.bodyRevenueSelected', context: context);
  ...
  late final _$setRevenueAsyncAction =
      AsyncAction('_RevenuesCoffeStore.setRevenue', context: context);
